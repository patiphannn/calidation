    ...
    function ValidatorsProvider() {
        ...
        return (
            (_ret = ((_temp = ((_this = _possibleConstructorReturn(
                this,
                (_ref =
                    ValidatorsProvider.__proto__ ||
                    Object.getPrototypeOf(ValidatorsProvider)).call.apply(
                    _ref,
                    [this].concat(args),
                ),
            )),
            _this)),
            (_this.state = _extends({}, _this.props.validators)),
            _temp)),
...
var withValidators = (exports.withValidators = function withValidators(
    TargetComponent,
) {
